...
class MovieAdapter(data: MutableList<Pair<Channel, List<Result>>>?): BaseQuickAdapter<Pair<Channel, List<Result>>, BaseViewHolder>(R.layout.item_recommend_video, data) {
