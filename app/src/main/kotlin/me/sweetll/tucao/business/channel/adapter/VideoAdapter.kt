...
class VideoAdapter(data: MutableList<ListResult>?): BaseQuickAdapter<ListResult, BaseViewHolder>(R.layout.item_video, data) {

    override fun convert(helper: BaseViewHolder, video: ListResult) {
