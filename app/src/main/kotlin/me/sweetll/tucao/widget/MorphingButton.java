...
public class MorphingButton extends androidx.appcompat.widget.AppCompatButton {
    ...
    private void initView() {
        ...
        int cornerRadius = (int) FloatExtensionsKt.dp2px(2f);
        int blue = resources.getColor(R.color.pink_400);
        int blueDark = resources.getColor(R.color.pink_700);
    ...
    public void setIcon(@DrawableRes final int icon) {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                Drawable drawable = new RingDrawable();
