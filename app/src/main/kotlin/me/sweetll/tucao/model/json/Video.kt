...
data class Video(val title: String,
    ...
    constructor(source: Parcel) : this(source.readString(), source.readString(), source.readString(), 1.equals(source.readInt()), source.readInt(), source.createTypedArrayList(Durl.CREATOR))
